...
class HomeController extends HomebaseController {
	...
	public function getUser(){
		$wechat = new WechatAuth("wx588c3000c72e2cfb","a03feb07a67792323773f301071db9ad");
		$code = $_GET['code'];
		if($code){
            ...
            $url = "http://{$_SERVER['HTTP_HOST']}{:U('portal/home/getUser'))}";
			//$url = "__ROOT_/index.php/portal/home/getUser";
    ...
    private function demo($wechat, $data){
        switch ($data['MsgType']) {
            case Wechat::MSG_TYPE_EVENT:
                switch ($data['Event']) {
                    case Wechat::MSG_EVENT_SUBSCRIBE:
                        $wechat->replyText('欢迎您关注同翼活动！我们专注于活动的发布报名，欢迎使用！');
                        break;
                    ...
                    default:
                        $wechat->replyText("欢迎访问同翼活动公众平台！您的事件类型：{$data['Event']}，EventKey：{$data['EventKey']}");
                        break;
                }
                break;
            ...
            case Wechat::MSG_TYPE_TEXT:
                switch ($data['Content']) {
                    case '文本':
                        $wechat->replyText('欢迎访问同翼活动公众平台，这是文本回复的内容！');
                        break;
                    ...
                    default:
                        $wechat->replyText("欢迎访问同翼活动公众平台！您输入的内容是：{$data['Content']}");
                        break;
                }
                break;
    ...
    private function upload($type){
        $appid     = 'wx588c3000c72e2cfb';
        $appsecret = 'a03feb07a67792323773f301071db9ad';
