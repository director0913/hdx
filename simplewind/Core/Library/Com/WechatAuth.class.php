	...
	**/
    ...
    public function getAccessToken($type = 'client', $code = null){
        ...
        if ($type == 'client') {
            ...
            // 获取基础支持中的access_token，需要把基础支持中的access_token缓存下来

            $global_access_token = S('global_access_token');
            ...
            if (empty($global_access_token)) {
                ...
                S('global_access_token', $token, $token['expires_in']);
            ...
            // 获取普通access_token，不需要缓存普通access_token
